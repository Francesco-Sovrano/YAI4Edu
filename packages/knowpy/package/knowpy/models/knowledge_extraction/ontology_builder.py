...
from knowpy.misc.graph_builder import get_root_set, get_concept_set, get_predicate_set, get_object_set, get_ancestors, filter_graph_by_root_set, tuplefy
...
class OntologyBuilder(KnowledgeGraphBuilder):
	...
	def build_edge_list(self, add_verbs=False, add_predicates_label=False):
	...
	def build(self, add_verbs=False, add_predicates_label=False):
		self.logger.info('Building knowledge graph..')
		edge_list = self.build_edge_list(add_verbs=add_verbs, add_predicates_label=add_predicates_label)
