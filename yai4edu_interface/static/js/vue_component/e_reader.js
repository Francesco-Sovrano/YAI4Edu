		...
		<div class="mx-3">
			...
			<overview_area :overview_api="overview_api" v-show="reading">
				...
				<p>
	            	...
	            	<br>
					You can also ask questions about the content covered by these excerpts.
					However, please note that this question answering tool has limited capabilities and cannot replace the excerpts, nor directly answer the assignment questions.
				</p>
				...
				<!--<b-form-select v-model="selected_book" required>
					<option :value="null" disabled>Select a book to read</option>
